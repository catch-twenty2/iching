#Iching Full Code 2023-10-22 as for collab
...
prompt = "As an I Ching diviner, provide interpretations for my question stated below. Write a paragraph for the current situation, the reasons driving the changes, and the resulting situation after the changes. Limit your research only to the sources from websites mentioned in this prompt. Use the following information I provide:\"\n"
